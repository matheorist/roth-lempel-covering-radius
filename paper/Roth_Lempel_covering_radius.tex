...
\begin{proposition}\label{prop:second-shell}
...
parity-check matrix in Proposition~\ref{prop:duality}.  Define
\[
\begin{aligned}
A_a(P)&=p_1-ap_0,\\
...
\href{https://github.com/matheorist/roth-lempel-covering-radius/blob/main/certificates/Roth_Lempel_boundary_certificates_supplement.tex}
{\path{Roth_Lempel_boundary_certificates_supplement.tex}}.
...
\href{https://github.com/matheorist/roth-lempel-covering-radius/blob/main/paper/Roth_Lempel_reproducibility_manifest_20260615.md}
{\path{Roth_Lempel_reproducibility_manifest_20260615.md}}, records the
