...
\(|S|=6\), reduced them under the affine action above, and either computed
the covering radius or certified radius \(4\) by an explicit uncovered
syndrome point for \(\RL_{4,\delta}(S)\).  This normalization is the natural affine
...
No listed class has radius below \(3\).
\begin{center}
...
For \(q=17,19,23,29,31,37\), Table~\ref{tab:negative-mds-nmds} shows the
...
An earlier one-slice certificate computation, searching first in the
...
two-slice scan below is the compact form reported in the article.
...
\href{https://github.com/matheorist/roth-lempel-covering-radius/blob/main/certificates/supplement.tex}
...
The accompanying
\href{https://github.com/matheorist/roth-lempel-covering-radius/blob/main/paper/reproducibility.md}
