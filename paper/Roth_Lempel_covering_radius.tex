...
For the prime-power fields below the threshold, the radius-three codes are
classified completely up to affine equivalence: their numbers are respectively
...
within this theoretical proof, only thirty residual affine representatives
over \(q=16,17,19\) require explicit finite certificates.  We further give
a \(56\)-factor polynomial whose
...
relations among all projective syndrome shells, including the exact formula
