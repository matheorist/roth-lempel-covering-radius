...
\title{A complete covering-radius threshold for length-eight\\
Roth--Lempel codes via trisecant-plane covers}
\author{Yong Zhang\\
...
For anonymous review, the complete Magma package and logs are supplied as
electronic supplementary material; the final version will place the code,
logs, and certificate files in the public repository
...
in Section~\ref{sec:reproducibility} and are supplied electronically.
