...
radius and explicitly decidable deep-hole syndromes for deep-hole-based
extension constructions; see Corollary~\ref{cor:seed-codes}.  The finite
part of the proof uses exact Magma enumeration, not randomized search.  The
...
deep hole in such a seed may choose \(P\) by this nonvanishing test.
\end{corollary}
