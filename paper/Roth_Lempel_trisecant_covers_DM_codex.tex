...
Thus the paper gives a complete structure theorem inside a classical
non-GRS MDS/NMDS family.  The result also supplies an infinite collection of
certified
...
\begin{proposition}[Parity-check duality]\label{prop:duality}
...
\begin{corollary}[Dual invariance of the MDS criterion]
...
\begin{proposition}[Second syndrome shell]\label{prop:second-shell}
...
\begin{proposition}[Uncovered syndromes as projection centers]\label{prop:projection}
...
\begin{proposition}[Fifty-six-factor uncovered-syndrome criterion]
...
\begin{proposition}[Affine covariance of twisted-cubic centers]
...
\begin{theorem}[Syndrome distance stratification]
...
layers proves the displayed stratification.  Finally, the trisecant cover is complete in a
...
\begin{corollary}[Large-field covering-radius bound]\label{cor:large-q}
...
\begin{proposition}[MDS and NMDS large-field refinements]\label{prop:large-q-refined}
...
\begin{corollary}[Deep-hole criterion for all \(q\ge16\)]
...
\begin{corollary}[Certified deep-hole seed codes]\label{cor:seed-codes}
...
deep hole in such a seed, such as the framework in
\cite{LiLuLingLam2026}, may choose \(P\) by this nonvanishing test.
\end{corollary}
...
when that slice contains no hole.  Table~\ref{tab:one-slice-certificates}
records the result; its final column is zero in every row.
\begin{center}
\captionof{table}{One-slice certificate search for \(q=17,\ldots,41\).}
\label{tab:one-slice-certificates}
\(
...
Table~\ref{tab:two-slice-certificates}, the final column again vanishes.
\begin{center}
...
\begin{longtable}{r r c c l r r}
\caption{Complete affine classification over \(\F_{11}\) for \(k=4,n=6\).}
\label{tab:q11-complete}\\
\toprule
idx & orbit & type & \(\rho\) & \(S\) & \(\delta\) & holes\\
\midrule
\endfirsthead
\toprule
idx & orbit & type & \(\rho\) & \(S\) & \(\delta\) & holes\\
\midrule
\endhead
1 & 110 & NMDS & 3 & \(\{0,1,2,3,5,6\}\) & 7  & 0\\
2 & 110 & NMDS & 3 & \(\{0,1,2,3,5,6\}\) & 5  & 0\\
3 & 110 & NMDS & 4 & \(\{0,1,2,3,5,6\}\) & 3  & 1\\
4 & 110 & NMDS & 3 & \(\{0,1,2,3,5,6\}\) & 1  & 0\\
5 & 110 & NMDS & 4 & \(\{0,1,2,3,5,6\}\) & 10  & 1\\
6 & 110 & NMDS & 4 & \(\{0,1,2,3,5,6\}\) & 8  & 1\\
7 & 110 & NMDS & 3 & \(\{0,1,2,3,5,6\}\) & 6  & 0\\
8 & 110 & NMDS & 3 & \(\{0,1,2,3,5,6\}\) & 4  & 0\\
9 & 110 & NMDS & 3 & \(\{0,1,2,3,5,6\}\) & 2  & 0\\
10 & 110 & NMDS & 4 & \(\{0,1,2,3,5,6\}\) & 0  & 1\\
11 & 110 & NMDS & 4 & \(\{0,1,2,3,5,6\}\) & 9  & 1\\
12 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 9  & 0\\
13 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 1  & 0\\
14 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 4  & 0\\
15 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 7  & 0\\
16 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 10  & 0\\
17 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 2  & 0\\
18 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 5  & 0\\
19 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 8  & 0\\
20 & 110 & NMDS & 4 & \(\{0,1,2,3,4,7\}\) & 0  & 1\\
21 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 3  & 0\\
22 & 110 & NMDS & 3 & \(\{0,1,2,3,4,7\}\) & 6  & 0\\
23 & 110 & NMDS & 4 & \(\{0,1,2,3,4,6\}\) & 6  & 1\\
24 & 110 & NMDS & 3 & \(\{0,1,2,3,4,6\}\) & 4  & 0\\
25 & 110 & NMDS & 3 & \(\{0,1,2,3,4,6\}\) & 2  & 0\\
26 & 110 & NMDS & 4 & \(\{0,1,2,3,4,6\}\) & 0  & 1\\
27 & 110 & NMDS & 4 & \(\{0,1,2,3,4,6\}\) & 9  & 1\\
28 & 110 & NMDS & 4 & \(\{0,1,2,3,4,6\}\) & 7  & 1\\
29 & 110 & NMDS & 3 & \(\{0,1,2,3,4,6\}\) & 5  & 0\\
30 & 110 & NMDS & 3 & \(\{0,1,2,3,4,6\}\) & 3  & 0\\
31 & 110 & NMDS & 3 & \(\{0,1,2,3,4,6\}\) & 1  & 0\\
32 & 110 & NMDS & 3 & \(\{0,1,2,3,4,6\}\) & 10  & 0\\
33 & 110 & NMDS & 4 & \(\{0,1,2,3,4,6\}\) & 8  & 1\\
34 & 110 & NMDS & 4 & \(\{0,1,2,3,4,10\}\) & 4  & 2\\
35 & 110 & NMDS & 3 & \(\{0,1,2,3,4,10\}\) & 0  & 0\\
36 & 110 & NMDS & 4 & \(\{0,1,2,3,4,10\}\) & 2  & 1\\
37 & 110 & NMDS & 4 & \(\{0,1,2,3,4,10\}\) & 3  & 2\\
38 & 55 & MDS & 3 & \(\{0,1,2,3,4,10\}\) & 10  & 0\\
39 & 110 & NMDS & 3 & \(\{0,1,2,3,4,10\}\) & 1  & 0\\
40 & 110 & NMDS & 3 & \(\{0,1,2,3,5,9\}\) & 2  & 0\\
41 & 110 & NMDS & 3 & \(\{0,1,2,3,5,9\}\) & 1  & 0\\
42 & 110 & NMDS & 3 & \(\{0,1,2,3,5,9\}\) & 0  & 0\\
43 & 55 & NMDS & 3 & \(\{0,1,2,3,5,9\}\) & 10  & 0\\
44 & 110 & NMDS & 3 & \(\{0,1,2,3,5,9\}\) & 3  & 0\\
45 & 110 & NMDS & 3 & \(\{0,1,2,3,5,9\}\) & 4  & 0\\
46 & 110 & NMDS & 4 & \(\{0,1,2,4,5,7\}\) & 0  & 1\\
47 & 110 & NMDS & 3 & \(\{0,1,2,4,5,7\}\) & 2  & 0\\
48 & 22 & MDS & 4 & \(\{0,1,2,4,5,7\}\) & 4  & 1\\
\bottomrule
\end{longtable}
...
and are available in the public repository above.
\end{sloppypar}
...
fields and the first automatic field.
\begin{center}
